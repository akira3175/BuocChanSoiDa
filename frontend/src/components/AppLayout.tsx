...
export default function AppLayout({
    ...
    return (
        <div className="relative flex h-dvh w-full flex-col bg-background-light overflow-hidden">
            {/* ─── HEADER ─── */}
            <header className="flex items-center bg-white/90 backdrop-blur-xl px-4 py-3 justify-between sticky top-0 z-20 border-b border-slate-100/80 animate-fade-slide-down">
